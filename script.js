...
async function saveProject() {
    ...
    try {
        ...
        // Replace the movies data section
        ...
        // Try to save to server (if admin server is running)
        ...
        function collectAll(list) {
            ...
            for (const item of list) {
                ...
                if (item.type === 'folder') {
                    ...
                    if (item.children) out.push(...collectAll(item.children));
